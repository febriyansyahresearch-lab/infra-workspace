...
|---|---|---|
| `projects/net_discovery/` | Network discovery & inventory (ping, SNMP, port scan) | 3 ✅ |
| `projects/docker_stacks/` | Docker Compose templates (nginx, app, db, monitoring) | 3 ✅ |
| `projects/monitor_agent/` | System health checker (CPU, memory, disk, alert) | 3 ✅ |
| `projects/storage_health/` | Storage monitoring (disk usage, SMART, IOPS) | 4 ✅ |
| `projects/iac_scripts/` | IaC templates (cloud-init, setup automation) | 3 ✅ |
